...
There are a couple of influences that guide the structure of this blog[^1]. The first influence is Michel de Montaigne’s [Essays](https://www.gutenberg.org/ebooks/3600). I want to write short, reflectively, and without worrying about what others would think if they read these articles. The second influence is John Gruber’s blog [daringfireball.net](https://daringfireball.net). I want to publish a text-first blog with a simple design.
